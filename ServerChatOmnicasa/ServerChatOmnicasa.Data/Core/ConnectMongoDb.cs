...
namespace ServerChatOmnicasa.Data.Core
{
    public class ConnectMongoDb
    {
        ...
        private IMongoCollection<InfoUserSms> _collection;
        ...
        //    {
        //        _id = document[nameof(InfoUserSms._id)].AsObjectId,
        ...
        public void ConnectDb(string connectString, string datatbaseName, string tableName)
        {
            ...
            _collection = _database.GetCollection<InfoUserSms>(tableName);
        }
